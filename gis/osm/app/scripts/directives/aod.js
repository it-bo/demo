...
angular.module('openlayers-directive', ['ngSanitize']).directive('openlayers', ["$log", "$q", "$compile", "olHelpers", "olMapDefaults", "olData", function($log, $q, $compile, olHelpers,
        ...
        return {
            ...
            template: '<div class="angular-openlayers-map" ng-transclude style="height:100%"></div>',
...
angular.module('openlayers-directive').directive('olPathDraw', ["$log", "$q", "olMapDefaults", "olHelpers", function($log, $q, olMapDefaults, olHelpers) {
    return {
        restrict: 'E',
        scope: {
            coords:'=coords',
...
angular.module('openlayers-directive').factory('olHelpers', ["$q", "$log", "$http", function($q, $log, $http) {
    ...
    var esriBaseLayers = ['World_Imagery', 'World_Street_Map', 'World_Topo_Map',
                          ...
                          'Ocean_Basemap', 'NatGeo_World_Map','wg','szj'];
    ...
    var createSource = function(source, projection) {
        ...
        switch (source.type) {
            ...
            case 'EsriBaseMaps':
                ...
                var _urlBase = 'http://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/';
